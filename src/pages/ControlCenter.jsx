...
export default function ControlCenter() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-athlonix-dark">
      ...
      <header className="sticky top-0 z-30 border-b border-gray-200 dark:border-white/5 bg-white/80 dark:bg-athlonix-dark/80 backdrop-blur-xl">
        <div className="px-6 lg:px-10 h-16 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <Link to="/" className="flex items-center gap-2 text-gray-500 dark:text-white/50 hover:text-gray-900 dark:hover:text-white transition-colors duration-300 text-sm">
              <ArrowLeft size={15} />
              <img src="/brand/logo-mark.png" alt="Athlenix" className="h-6 w-auto" />
            </Link>
            <span className="text-gray-300 dark:text-white/20">/</span>
            <span className="text-sm text-gray-700 dark:text-white/70 font-medium">Control Center</span>
          </div>
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-full bg-gradient-to-br from-athlonix-blue/30 to-athlonix-blue/5 border border-white/10 flex items-center justify-center text-[11px] font-display font-semibold text-gray-900 dark:text-white">
              LA
            </div>
          </div>
        </div>
